...
#' 
#' @details Parameters \code{lb,ub} are end points for a range of search for the 
...
#' 
#' 
#' @param X a \eqn{n\times k} matrix where columns are \eqn{k} objects to be clustered, 
